...
return [
    'welcome'                => 'Добро пожаловать в Navia Compass. Каждое хорошее приложение нуждается в компасе, чтобы указать им в правильном направлении.
     В этом разделе вы найдете много ресурсов и административных задач, которые помогут вам в создании вашего приложения.',
    'links'         => [
        'title'                 => 'Ссылки',
        'documentation'         => 'Документация',
        'voyager_homepage'      => 'Страница Navia',
    ],
    'commands'      => [
        'title'                 => 'Команды',
        'text'                  => 'Запустите команду Artisan от Navia.',
    ...
    'resources'     => [
        'title'                 => 'Ресурсы',
        'text'                  => 'Ресурсы Navia, которые помогут вам найти вещи быстрее.',
    ...
    'fonts'         => [
        'title'                 => 'Шрифты',
        'font_class'            => 'Карта классов шрифта Navia',
        'font_character'        => 'Карта символов шрифта Navia',
    ],
];
