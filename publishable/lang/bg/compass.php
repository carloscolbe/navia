...
return [
    'welcome'                => 'Добре дошли във Navia Compass. Всяка хубава апликация има нужда от компас да насочва потребителите към правилната посока.
    ...
    'commands'      => [
        'title'                 => 'Команди',
        'text'                  => 'Run Artisan команди от Navia.',
    ...
    'resources'     => [
        'title'                 => 'Ресурси',
        'text'                  => 'Navia ресурси, които ще ви помогнат да намерите всичко по-бързо.',
