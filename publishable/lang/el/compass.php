...
return [
    'welcome'                => 'Καλωσήρθατε στην Πυξίδα Navia. Κάθε καλή εφαρμογή χρειάζεται μία πυξίδα για να σας καθοδηγήσει προς τη σωστή κατεύθυνση. Σε αυτό τον τομέα θα βρείτε πολλές πηγές και ενέργειες διαχείρισης που θα σας βοηθήσουν όσο χτίζετε την εφαρμογή σας.',
    'links'                  => [
        'title'                 => 'Σύνδεσμοι',
    ...
    'commands'      => [
        'title'                 => 'Εντολές',
        'text'                  => 'Τρέξτε Artisan εντολές μέσα από το Navia.',
    ...
    'resources'     => [
        'title'                 => 'Πηγές',
        'text'                  => 'Πηγές για το Navia ώστε να βρείτε ό,τι ψάχνετε γρηγορότερα.',
