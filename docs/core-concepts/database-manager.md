...
Voyager has some awesome database tools which allow you to Add/Edit/Delete or view current database tables. The other cool part of Navia is that you can add BREAD or \(Browse, Read, Edit, Add, & Delete\) functionality to any of your tables.
