...
'assets_path' => '/vendor/carloscolbe/navia/assets',
```
...
{% hint style="info" %}
When upgrading to new version of naviathe assets located in the `/vendor/carloscolbe/navia/assets` directory may need to be overwritten, so if you wish to customize any styles you will want to duplicate that directory and specify the new location of your asset\_path.
{% endhint %}
...
**widgets** Here you can manage the widgets that live on your dashboard. You can take a look at an example widget class by viewing the current widgets inside of `carloscolbe/navia/src/Widgets`.
