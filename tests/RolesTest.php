...
class RolesTest extends TestCase
{
    ...
    public function testRoles()
    {
        ...
        // Deleting a Role
        $response = $this->call('DELETE', route('navia.roles.destroy', $superadmin_role->id), ['_token' => csrf_token()]);
