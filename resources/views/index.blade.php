...
@section('content')
    <div class="page-content">
        ...
        @include('navia::dimmers')
        <div class="analytics-container">
            <?php $google_analytics_client_id = Navia::setting("admin.google_analytics_client_id"); ?>
            @if (isset($google_analytics_client_id) && !empty($google_analytics_client_id))
                {{-- Google Analytics Embed --}}
                <div id="embed-api-auth-container"></div>
            @else
                <p style="border-radius:4px; padding:20px; background:#fff; margin:0; color:#999; text-align:center;">
                    {!! __('navia::analytics.no_client_id') !!}
            ...
            <div class="Dashboard Dashboard--full" id="analytics-dashboard">
                <header class="Dashboard-header">
                    <ul class="FlexGrid">
                        <li class="FlexGrid-item">
                            <div class="Titles">
                                <h1 class="Titles-main" id="view-name">{{ __('navia::analytics.select_view') }}</h1>
                                <div class="Titles-sub">{{ __('navia::analytics.various_visualizations') }}</div>
                            </div>
                        </li>
                ...
                <ul class="FlexGrid FlexGrid--halves">
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('navia::analytics.this_vs_last_week') }}</h1>
                                <div class="Titles-sub">{{ __('navia::analytics.by_users') }}</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('navia::analytics.this_vs_last_year') }}</h1>
                                <div class="Titles-sub">{{ __('navia::analytics.by_users') }}</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('navia::analytics.top_browsers') }}</h1>
                                <div class="Titles-sub">{{ __('navia::analytics.by_pageview') }}</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">{{ __('navia::analytics.top_countries') }}</h1>
                                <div class="Titles-sub">{{ __('navia::analytics.by_sessions') }}</div>
                            </header>
        ...
        <script>
            ...
            gapi.analytics.ready(function () {
                ...
                var viewSelector = new gapi.analytics.ext.ViewSelector2({
                    ...
                    propertyId: '{{ Navia::setting("site.google_analytics_tracking_id")  }}'
                })
                        .execute();
                ...
                function renderYearOverYearChart(ids) {
                    ...
                    Promise.all([thisYear, lastYear]).then(function (results) {
                        ...
                        var data = {
                            ...
                            datasets: [
                                {
                                    label: '{{ __('navia::date.last_year') }}',
                                    fillColor: 'rgba(220,220,220,0.5)',
                                    strokeColor: 'rgba(220,220,220,1)',
                                    data: data2
                                },
                                {
                                    label: '{{ __('navia::date.this_year') }}',
                                    fillColor: 'rgba(151,187,205,0.5)',
                                    strokeColor: 'rgba(151,187,205,1)',
                                    data: data1
                                }
