<a class="btn btn-danger" id="bulk_delete_btn"><i class="navia-trash"></i> <span>{{ __('navia::generic.bulk_delete') }}</span></a>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <i class="navia-trash"></i> {{ __('navia::generic.are_you_sure_delete') }} <span id="bulk_delete_count"></span> <span id="bulk_delete_display_name"></span>?
                </h4>
            </div>
