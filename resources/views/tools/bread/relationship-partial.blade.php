...
<div class="row row-dd row-dd-relationship">
    ...
    <div class="col-xs-2">
        ...
        <label for="field_browse_{{ $relationship['field'] }}"> {{ __('navia::database.relationship.browse') }}</label><br>
        ...
        <label for="field_read_{{ $relationship['field'] }}"> {{ __('navia::database.relationship.read') }}</label><br>
        ...
        <label for="field_edit_{{ $relationship['field'] }}"> {{ __('navia::database.relationship.edit') }}</label><br>
        ...
        <label for="field_add_{{ $relationship['field'] }}"> {{ __('navia::database.relationship.add') }}</label><br>
        ...
        <label for="field_delete_{{ $relationship['field'] }}"> {{ __('navia::database.relationship.delete') }}</label><br>
    </div>
    <div class="col-xs-2">
        <p>{{ __('navia::database.relationship.relationship') }}</p>
    </div>
    <div class="col-xs-2">
    ...
    <div class="col-md-12 navia-relationship-details">
        ...
        <div class="relationship_details_content">
            ...
            <span><input type="text" class="form-control" name="relationship_model_{{ $relationship['field'] }}" placeholder="{{ __('navia::database.relationship.namespace') }}" value="{{ $relationshipDetails->model ?? '' }}"></span>
        </div>
        ...
        <div class="relationship_details_content margin_top">
            <label>{{ __('navia::database.relationship.display_the') }} <span class="label_table_name"></span></label>
            ...
            <div class="belongsToShow belongsToManyShow relationship_details_content" style="flex:1">
                <label class="relationship_key">{{ __('navia::database.relationship.store_the') }} <span class="label_table_name"></span></label>
            ...
            <div class="hasOneShow hasManyShow relationship_details_content" style="flex:1">
                <label class="relationship_key">{{ __('navia::database.relationship.store_the') }}
            ...
            @isset($relationshipDetails->taggable)
                <label class="relationship_taggable">
                    {{__('navia::database.relationship.allow_tagging')}}
                </label>
                <span class="relationship_taggable">
                    <input type="checkbox" name="relationship_taggable_{{ $relationship['field'] }}" class="toggleswitch" data-on="{{ __('navia::generic.yes') }}" data-off="{{ __('navia::generic.no') }}" {{$relationshipDetails->taggable == 'on' ? 'checked' : ''}}>
                </span>
            @endisset
        </div>
        <div class="relationship_details_content margin_top">
            <div class="col-xs-12" style="margin: 0px !important; padding: 0px !important;">
                ...
                <label>{{ __('navia::database.relationship.relationship_details') }}</label>
